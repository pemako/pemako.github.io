...
- [z_reading_guide.md](z_reading_guide.md) — `rupa/z` 源码拆解：frecency 公式、aging 机制、Shell 冷僻语法与原子性设计
...
- 精读源码：[`rupa/z`](z_reading_guide.md) → `direnv/stdlib.sh` → `bash-completion/completions/` → `fzf` 的 shell 集成
