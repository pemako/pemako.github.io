...
* CentOS\_7.7.1908\_VMM 
* 提前解决macOS Catalina系统Vmware Fusion虚拟机黑屏问题
  * 参考: [https://zhuanlan.zhihu.com/p/108613520](https://zhuanlan.zhihu.com/p/108613520)
  * 主要包括下面几步进行解决
...
* 提前配置好[阿里云](https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors)docker镜像加速器
  * 我的镜像加速地址 [https://cxjmzodm.mirror.aliyuncs.com](https://cxjmzodm.mirror.aliyuncs.com)
...
* web访问
  ...
  > 注意一定要使用https 通过token的方式访问；dashboard部署在了master节点（ip:192.168.156.128）映射的端口为 `30001` 故访问的时候直接使用 [https://192.168.156.128:30001/](https://192.168.156.128:30001/) 即可

* 效果展示 ![2yPHK.png](https://wx2.sbimg.cn/2020/07/05/2yPHK.png) ![2yDAI.png](https://wx1.sbimg.cn/2020/07/05/2yDAI.png)
...
* 查看dashboard的详细参数
  * [https://github.com/kubernetes/dashboard/blob/master/docs/common/dashboard-arguments.md](https://github.com/kubernetes/dashboard/blob/master/docs/common/dashboard-arguments.md)

### 附录参考

* [https://github.com/kubernetes/kubeadm/blob/master/docs/design/design\_v1.10.md\#kubeadm-init-phases](https://github.com/kubernetes/kubeadm/blob/master/docs/design/design_v1.10.md#kubeadm-init-phases)
* [https://www.backendcloud.cn/2020/04/10/centos7-7-k8s-3nodes/](https://www.backendcloud.cn/2020/04/10/centos7-7-k8s-3nodes/)
* [https://developer.aliyun.com/article/754337](https://developer.aliyun.com/article/754337)
