...
* 创建证书
  ...
  * 5、codesign -f -s gdb\_cert $\(which gdb\)
  * 6、如不生效重启电脑
* Go环境设置
...
* 3、[https://golang.org/doc/gdb\#Known\_Issues](https://golang.org/doc/gdb#Known_Issues)
