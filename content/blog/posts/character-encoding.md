...
字节是计算机中存储数据的最小单元，一个字节有 `8` 个位（即二进制位，也叫 `bit`），也可以表示 `0~255` 之间的任何一个数（即二进制的 `0000 0000` 到 `1111 1111` 之间）。可以用字节表示任何东西，如数字、字符、图像、音乐等，这取决于你如何解释这个字节。
...
| ----------------------- | --------------------- |
| 00 0000 - 00 007F | 0xxxxxxx ASCII码  |
...
2. https://bilibili.com/video/BV1xD4y1y7yc
3. http://www.cnblogs.com/golove/p/3222096.html
4. https://www.51cto.com/article/661981.html
