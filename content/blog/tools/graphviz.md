...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071753958.png)

上面是用`dot`命令来生成，也可以用 Graphviz 中包含的其它命令来处理 dot 文本，比如用下面命令渲染出来的图片排列方式则不一样。

```
neato demo.dot -T png -o demo.png
```

![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071753627.png)

本文后面的示例都以dot命令来渲染。

## 1.5 开发工具

可以直接通过上面的这种命令生成，缺点就是看不到实时效果。有一些工具可以实时查看，我这里使用的是 `vscode` 的`PlantUML` 插件。`Atom`、`Sublime` 应该也都有自己的插件，`Eclipse` 上也可以安装 `PlantUML`。Plantuml支持 dot 需要将开头的 `@startuml` 和结尾的 `@enduml` 换成 `@startdot` 和 `@enddot`，也可以在前面加个`//`或者`#`(`#@startdot`  `#@enddot`)，这样子`dot`命令生成的时候也不需要额外注释掉该部分。
...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071753628.png)
...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071757204.png)
...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071759972.png)
...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071759183.png)
...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071800347.png)
...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071800829.png)
...
![](https://raw.githubusercontent.com/pemako/assets/main/2022/202212071800461.png)
